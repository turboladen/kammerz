...
use crate::entities::lab::{self, Entity as Lab};
...
impl LabService {
    ...
    pub async fn create(db: &DatabaseConnection, model: lab::ActiveModel) -> Result<lab::Model, DbErr> {
        model.insert(db).await
    }

    pub async fn update(db: &DatabaseConnection, model: lab::ActiveModel) -> Result<lab::Model, DbErr> {
