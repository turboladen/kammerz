...
use crate::entities::camera_lens::{self, Entity as CameraLens};
use crate::entities::lens::{self, Entity as Lens};
...
impl LensService {
    ...
    pub async fn update(db: &DatabaseConnection, model: lens::ActiveModel) -> Result<lens::Model, DbErr> {
